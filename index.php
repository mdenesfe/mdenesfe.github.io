...
<html lang="en">
  <head>
    <title>Enes Demir &mdash; CS Student</title>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">

    <meta name="description" content="">
    <meta name="keywords" content="enes, demir, Artifical Intelligence, Machine, Learning, Data, Science">
    <meta name="author" content="Enes Demir">
        ...
        <div class="container">
          ...
          <div class="row align-items-center justify-content-between text-left">
            ...
            <div class="site-logo pos-absolute">
              <a href="index.html" class="unslate_co--site-logo">Enes Demir<span>.</span></a>
            </div>
        ...
        <div class="container">
          <div class="row align-items-center">
            ...
            <div class="col-md-7 mx-auto text-center">
              <h2 class="subheading gsap-reveal-hero">I’m Enes Demir | Computer Science Student and Developer </h2>
            </div>
      ...
      <div class="unslate_co--section" id="journal-section">
        <div class="container">
          <div class="section-heading-wrap text-center mb-5">
            <h2 class="heading-h2 text-center divider"><span class="gsap-reveal">My Blog</span></h2>
         ...
         <!-- <div class="row gutter-v4 align-items-stretch">
              ...
              <a href="football-simule.html" class="grid-item blog-item w-100 h-100">
                <div class="overlay">
                  <div class="portfolio-item-content">
                    <h3>Football Simule</h3>
                    <p class="post-meta">Python <span class="small">&bullet;</span> 2 mins read</p>
                  </div>
                </div>
                <img src="images/football-simule.jpg" class="lazyload" alt="Image" />
              </a>
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4 blog-post-entry" data-aos="fade-up" data-aos-delay="0">
              ...
              <a href="tic-tac-toe.html" class="grid-item blog-item w-100 h-100">
                <div class="overlay">
                  <div class="portfolio-item-content">
                    <h3>Tic Tac Toe AI</h3>
                    <p class="post-meta">Python <span class="small">&bullet;</span> 1 mins read</p>
                  </div>
                </div>
